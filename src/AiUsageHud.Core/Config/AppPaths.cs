...
/// <list type="bullet">
/// <item>Config: <c>%APPDATA%\ai-usage-hud\config.toml</c></item>
/// <item>Cache:  <c>%LOCALAPPDATA%\ai-usage-hud\&lt;vendor&gt;\</c></item>
...
{
    public const string AppFolderName = "ai-usage-hud";
