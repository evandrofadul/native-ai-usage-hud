...
/// <item>Linux: an XDG autostart entry at <c>~/.config/autostart/ai-usage-hud.desktop</c>.</item>
/// </list>
...
public static class AutoStartManager
{
    ...
    private static string LinuxDesktopFile => Path.Combine(LinuxAutostartDir, "ai-usage-hud.desktop");
