using AiUsageHud.App.Platform;
using AiUsageHud.App.Themes;
using AiUsageHud.App.Tray;
...
public partial class App : Application
{
    ...
    private const string SingleInstanceMutexName = @"Local\AiUsageHud.SingleInstance.Avalonia";
